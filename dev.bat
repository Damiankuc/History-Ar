@echo off
title Levantar Entorno History-Ar
echo ===================================================
echo   Iniciando Servidores en Desarrollo - History-Ar
echo ===================================================
echo.

:: 1. Lanzar el Backend en una ventana nueva
echo Levantando API de FastAPI (SQLite) en puerto 8000...
start "History-Ar API Backend" cmd /k "cd backend && .venv\Scripts\activate && python -m uvicorn app.main:app --reload --port 8000"

:: 2. Lanzar el Frontend en otra ventana
echo Levantando Frontend de React (Vite) en puerto 1420...
start "History-Ar React Frontend" cmd /k "cd frontend && npm run dev"
